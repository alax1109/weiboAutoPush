...
深圳地区和仁爱医院病种
"""
sz_loc = './地区/sz_location.txt'
ra_disease = './病种/ra_disease_renliu.txt'

"""
厦门地区和鹭港医院病种
"""

xm_loc = './地区/xm_location.txt'
lg_disease = './病种/lg_disease_renliu.txt'

"""
东莞地区和东方医院病种
"""
dg_loc = './地区/dg_location.txt'
df_disease = './病种/df_disease.txt'
"""
台州
"""
tz_loc = './地区/tz_location.txt'
tz_disease = './病种/tz_disease.txt'
"""
宁波
"""
nb_loc = './地区/nb_location.txt'
nb_disease = './病种/nb_disease.txt'
"""
温州
"""
wz_loc = './地区/wz_location.txt'
wz_disease = './病种/wz_disease.txt'
"""
账号密码
"""
sz_account = ''
...
修饰词
"""
compose_key = './组合词/compose_key.txt'
with open('./随机文章内容/rand_content.txt', 'r', encoding='UTF-8') as rand_s:
...
ra_upload_img_dir = '\\renai_pic'
lg_upload_img_dir = '\\lugang_pic'
...
if len(sz_account) % 4 == 0:
    while len(sz_account) >= 4:
        ...
        sleep(8)
        # 文章发布次数
        while WebDriverWait(browser, 10).until(EC.element_to_be_clickable((By.CSS_SELECTOR, ".func a[node-type='submit']"))) and ra_post_time <= sz_account[-1]:
            sleep(2)
...
#         sleep(8)
#         # 文章发布次数
#         while WebDriverWait(browser, 10).until(EC.element_to_be_clickable((By.CSS_SELECTOR, ".func a[node-type='submit']"))) and lg_post_time <= xm_account[-1]:
#             sleep(2)
#             upload = browser.find_element_by_css_selector(
#                 'form[id="pic_upload"]').click()
#             for up_img in img:
